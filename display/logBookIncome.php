...
function getDataLogbook($bulan = null, $deskripsi = null)
{
    ...
    if ($bulan != null || $deskripsi != null) {
        $data = $keuangan->filterLogbook($bulan, $deskripsi, "income");
        return $data;
    } else {
        $data = $keuangan->getAllLogbook("income");
        return $data;
    }
}
                ...
                <div class="detail">
                    <div class="filter">
                        ...
                        <div class="filterForm">
                            <h4>Filter :</h4>
                            <form action="logBookIncome.php" method="post">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= $d['totalUang'] ?></td>
                                            <td><?= $d['deskripsi'] ?></td>
                                            <td><button class="btnSubmit orange"><a href="logBookIncome.php?status=edit&id=<?= $d['idLogbook'] ?>">Edit</a></button>
                                                <button class="btnSubmit red"><a href="../Logbook_controller.php?status=hapusIncome&id=<?= $d['idLogbook'] ?>">Hapus</a></button></td>
                                        </tr>
                                <?php
                                    endforeach;
                                else :
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= $d['deskripsi'] ?></td>
                                            <td><button class="btnSubmit orange"><a href="logBookIncome.php?status=edit&id=<?= $d['idLogbook'] ?>">Edit</a></button>
                                                <button class="btnSubmit red"><a href="../Logbook_controller.php?status=hapusIncome$d ['idLogbook']?>">Hapus</a></button></td>
                                        </tr>
                                <?php
                                    endforeach;
                                endif;
